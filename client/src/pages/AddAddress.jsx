...
const handleChange = (e) => {
    ...
    setAddress((prevAddress) => {
        ...
        //console.log("State updated:", newAddress);
        return newAddress;
    });
};
  ...
  return (
    ...
    <div className='mt-16 pb-16'>
        ...
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'> {/* two columns , one is div and one is image* */}
            <div className='flex-1 max-w-md'>
                ...
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <InputField handleChange={handleChange} address={address} name = 'phoneNo' type = 'tel'
                    placeholder = 'Phone'/>
